...
(function($, window) {
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    bind: function(name, data, callback) {
      ...
      if(this.listener_mappings[uid] === undefined) {
          this.listener_uids.push(uid);
          this.listener_mappings[uid] = listener_callback;
      } 
    ...
    unbind: function(name, uid) {
        if(this.listener_mappings[uid]) {
            this._unlisten(name, this.listener_mappings[uid]);
    ...
    bindOneShot: function(context, name, callback) {
        var uid = context.bind(name, function() {
            try {
                context.unbind(name, uid);
                callback.apply(this, arguments);
            } catch(e) { console.log("Failed to unbind: "+e); }
        }).listener_uids.pop();
        return this;
    },
