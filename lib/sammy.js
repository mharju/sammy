...
(function($, window) {
  ...
  Sammy.Application.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    bind: function(name, data, callback) {
      ...
      this.listener_mappings[callback] = listener_callback;
      if (this.isRunning()) {
    ...
    //   alert('one time!');
    //   this.unbind('test', arguments.callee);
    // });
    // 
    unbind: function(name, callback) {
        if(this.listener_mappings[callback]) {
            this._unlisten(name, this.listener_mappings[callback]);
            delete this.listener_mappings[callback];
        }
    },
